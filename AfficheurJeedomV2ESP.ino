...
// Connection via WiFi
//
// Généré le 2023-12-04 18:13:27.
// Pour l'équipement Afficheur cuisine (EqID : 114 ).
// Modèle de carte : esp32dev.
////////
...
const char* ssid = "caviarde";
const char* password = "caviarde";

#if (NODHCP == 1)
	byte GATEWAY[] = { 192, 168, 0, 1 };
	byte SUBNET[] = { 255, 255, 255, 0 };
#endif
byte IP_ARDUINO[] = { 192, 168, 0, 33 };
byte IP_JEEDOM[] = { 192, 168, 0, 39 };
...
int etat25 = digitalRead(pin25);
int etat26 = digitalRead(pin26);
int etat27 = digitalRead(pin27);

if (etat25 == HIGH && animdebut==0) {
...
if (etat25 == HIGH && animdebut==1 && etat26 == HIGH) {
...
if (etat25 == HIGH && animdebut==1 && etat26 == LOW) {
...
void WIFI_Connect()
{
	...
	#if defined(ARDUINO_ARCH_ESP8266)
	WiFi.hostname("JeedouinoESP_114");
	#endif
	WiFi.enableAP(0);
...
void Init_EEPROM()
{
	...
	eqLogic = F("114");					// Sauvegarde de eqLogic pour 1er boot apres 1er flashage
